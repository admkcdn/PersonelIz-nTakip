<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="PersonelIzınTakip.Main" %>
...
<body>
	...
	<div class="main">
		<div class="main-w3l">
			<h1 class="logo-w3">Personel İzİn SİSTEMİ</h1>
			<div class="w3layouts-main">
					<form action="#" method="post" runat="server">
						<asp:Button ID="btnAdmin" runat="server" Text="GİRİŞ YAP" OnClick="btnAdmin_Click"/>
					</form>
			</div>
			<!-- //main -->
